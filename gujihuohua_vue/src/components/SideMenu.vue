...
import { EditPen, Collection, PriceTag, Connection, Timer, User, Reading, List, Management } from '@element-plus/icons-vue'
...
.nav-menu li { padding: 15px 30px; cursor: pointer; transition: all 0.3s; display: flex; align-items: center; font-size: 15px; color: #909399; }
